...
const NavBar = () => {
    ...
    const navItems = <>
        ...
        <label className="toggle text-base-content">
            <input onChange={handleThemeChange} type="checkbox" checked={theme === "synthwave"} value="synthwave" className="theme-controller" />
    ...
    return (
        ...
        <div className="navbar bg-base-300 shadow-lg md:px-8 fixed top-0 z-10 md:h-10">
